...
def test_login_form():
    ...
    login_button.click()
    try:
        error_message = WebDriverWait(driver,10).until(EC.presence_of_element_located((By.XPATH, "//*[text()[contains(.,'Epic sadface: Username and password do not match any user in this service')]]")))
